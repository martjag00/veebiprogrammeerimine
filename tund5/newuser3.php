<?php
  ...
  if(isset($_POST["gender"]) and !empty($_POST["gender"])){
	$gender = intval($_POST["gender"]); //POST'iga on alati kõik tähemärgid(ilma intval'ita)
  } else {
  ...
  //kontrollime kuupäeva valiidsuse 
 ...
 }//kuupäeva legaalsuse kontrollimine
...
<body>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<br>
	<label>E-postiaadress (kasutajatunnseks): </label><br>
